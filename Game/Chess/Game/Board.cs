...
namespace Game
{
    class Board
    {
        public static const char	BOARD_PIECE_NULL		= 'x';
        public static const char    BOARD_PIECE_EMPTY       = '0';
        ...
        public bool checkTest(bool white)
        {
            for (int i=1; i<=dimension[1]; ++i)
		        for (int j=1; j<=dimension[0]; ++j)
		        {
			        ...
			        if (sym != Board.BOARD_PIECE_EMPTY && sym != Board.BOARD_PIECE_NULL)
			        {
				        bool enemy;
        ...
        public bool checkmateTest(bool white)
        {
            for (int i=1; i<=dimension[1]; ++i)
		        for (int j=1; j<=dimension[0]; ++j)
		        {
			        ...
			        if (sym != Board.BOARD_PIECE_NULL && sym != Board.BOARD_PIECE_EMPTY)
			        {
				        bool enemy;
